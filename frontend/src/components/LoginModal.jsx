    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative glass-panel hud-frame rounded-sm w-full max-w-md p-8" style={{animation:'scaleIn 0.25s ease-out'}}>
        ...
        <div className="text-center mb-8 pt-4">
          ...
          <h2 className="font-sora text-xl font-bold text-white tracking-wider">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={isLoading}
            className="btn-cyber-solid w-full py-3 font-sora text-sm tracking-widest mt-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
            {isLoading ? (
